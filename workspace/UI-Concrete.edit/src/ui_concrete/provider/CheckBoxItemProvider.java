	...
	protected void addColumnSQLPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CheckBox_columnSQL_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CheckBox_columnSQL_feature", "_UI_CheckBox_type"),
				 Ui_concretePackage.Literals.CHECK_BOX__COLUMN_SQL,
				 true,
				 false,
				 true,
				 null,
