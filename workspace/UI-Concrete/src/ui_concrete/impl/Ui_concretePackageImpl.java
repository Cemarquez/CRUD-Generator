...
public class Ui_concretePackageImpl extends EPackageImpl implements Ui_concretePackage {
	 ...
	 */
	@Override
	public EReference getUI_Diagram_LtsButtonActions() {
	 ...
	 */
	@Override
	public EReference getUI_Diagram_LstColumns() {
		return (EReference)uI_DiagramEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getColumn_Db() {
	 ...
	 */
	@Override
	public EReference getCheckBox_ColumnSQL() {
		return (EReference)checkBoxEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getTextInput_ColumnSQL() {
	 ...
	 */
	@Override
	public EAttribute getButtonAction_Name() {
		return (EAttribute)buttonActionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getButtonAction_LtsGraphicalIndividual() {
		return (EReference)buttonActionEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getButtonAction_ButtonAction() {
		return (EReference)buttonActionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getButtonAction_Action() {
		return (EAttribute)buttonActionEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		createEReference(uI_DiagramEClass, UI_DIAGRAM__LTS_BUTTON_ACTIONS);
		createEReference(uI_DiagramEClass, UI_DIAGRAM__LST_COLUMNS);
		...
		createEAttribute(columnEClass, COLUMN__DB);
		...
		createEReference(checkBoxEClass, CHECK_BOX__COLUMN_SQL);
		...
		createEReference(textInputEClass, TEXT_INPUT__COLUMN_SQL);
		...
		createEAttribute(buttonActionEClass, BUTTON_ACTION__NAME);
		createEReference(buttonActionEClass, BUTTON_ACTION__LTS_GRAPHICAL_INDIVIDUAL);
		createEReference(buttonActionEClass, BUTTON_ACTION__BUTTON_ACTION);
		createEAttribute(buttonActionEClass, BUTTON_ACTION__ACTION);
	...
	public void initializePackageContents() {
		...
		initEReference(getUI_Diagram_LtsButtonActions(), this.getButtonAction(), null, "ltsButtonActions", null, 0, -1, UI_Diagram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUI_Diagram_LstColumns(), this.getColumn(), null, "lstColumns", null, 0, -1, UI_Diagram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getColumn_Db(), ecorePackage.getEString(), "db", null, 0, 1, Column.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCheckBox_ColumnSQL(), this.getColumn(), null, "columnSQL", null, 0, 1, CheckBox.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTextInput_ColumnSQL(), this.getColumn(), null, "columnSQL", null, 0, 1, TextInput.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getButtonAction_Name(), ecorePackage.getEString(), "name", null, 0, 1, ButtonAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getButtonAction_LtsGraphicalIndividual(), this.getGraphicalIndividual(), null, "ltsGraphicalIndividual", null, 0, -1, ButtonAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getButtonAction_ButtonAction(), this.getButton(), null, "buttonAction", null, 0, 1, ButtonAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getButtonAction_Action(), this.getAction(), "action", null, 0, 1, ButtonAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
