 ...
 * @generated
 */
public class ButtonActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ButtonActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ui_concrete.diagram.providers.Ui_concreteParserProvider.getParser(
					ui_concrete.diagram.providers.Ui_concreteElementTypes.ButtonAction_2002, getParserElement(),
